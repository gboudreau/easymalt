...
VALUES
  ...
  ('Family Outing', 'no'),
  ('Family Outing: Concert', 'no'),
  ('Family Outing: Landmark', 'no'),
  ('Family Outing: Museum', 'no'),
  ('Family Outing: Tour', 'no'),
  ('Family Outing: Show', 'no'),
  ('Family Outing: Cinema', 'no'),
  ('Family Outing: Game', 'no'),
  ('Family Outing: Sports', 'no'),
  ('Family Outing: Zoo', 'no'),
  ...
  ('Travel: Transport', 'no'),
  ('Travel: Transport: Plane', 'no'),
  ('Travel: Transport: Train', 'no'),
  ('Travel: Hotel', 'no'),
  ('Travel: Vacation', 'no'),
  ('Watches', 'no');
